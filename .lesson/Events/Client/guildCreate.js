...
export default async (client, guild) => {
  ...
  hook.send({
    content: "**Server Joined <@&1178780343273263156>**",
    embeds: [embed],
  });
  const serversendingembed = new EmbedBuilder()
    ...
    .setTitle(
      `**Hey! Iam MonsterBunny A Top Quality Music Bot With Lots Of Commands. 24/7 And Autoplay Like Premium Features Are Free**`
    )
    // .setURL("https://discord.com/invite/Z4GTY8yMat")
    .setDescription(
      `\n\n**[Invite](https://discord.com/oauth2/authorize?client_id=${client.user.id}&permissions=37088600&scope=bot%20applications.commands) • [Support Server](https://discord.com/invite/Z4GTY8yMat)**\n`
    )
