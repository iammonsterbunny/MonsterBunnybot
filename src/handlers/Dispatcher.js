...
export default async (client, message) => {
  client.kazagumo.on("playerStart", async (player, track) => {
    ...
    .setFooter({
      text: `Thanks for using Monster Bunny music bot ❤️`
    });
    ...
    const pauseandres = new ButtonBuilder()
      ...
      .setEmoji(`1184105869940633641`)
      .setLabel(player.playing ? "Pause" : "Resume");
    const skip = new ButtonBuilder()
      .setStyle(client.Buttons.grey)
      .setCustomId("skip")
      .setEmoji(`1184107919906709634`)
      .setLabel("Skip")
    const stop = new ButtonBuilder()
      .setStyle(client.Buttons.red)
      .setCustomId("stop")
      .setEmoji(`1184109446394290256`)
      .setLabel("Stop")
