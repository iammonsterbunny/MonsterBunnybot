...
export default class ColdClient extends Client {
  constructor() {
    ...
    (this.helpMessages = [
      ...
      "Premium is cheap Just Boost our server [support server](https://discord.com/invite/Z4GTY8yMat) and report bugs!",
      ...
      "[Xenin](https://discord.com/users/1151631733003919491) is the **Developer** of Cold",
    ]),
