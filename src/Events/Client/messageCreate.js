  ...
  if (command) {
    ...
    if (
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `**Looks Like You Found A Premium Command!** This Command Is Valid For Premium Servers Only! Buy Premium By Joining [Support Server](https://discord.com/invite/Z4GTY8yMat) <:cold_prime:1171997414329163828> `
        )
